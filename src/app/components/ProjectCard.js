...
export default function ProjectCard({ title, description, cardImage, video, videoPoster, tags, slug, url }) {
  ...
  return (
    <div
      onClick={handleClick}
      className="relative block text-white shadow-md overflow-hidden border-4 border-gray-900 transition-shadow duration-300 ease-in-out hover:shadow-solid-s rounded-2xl cursor-pointer"
      ...
      <div className="relative w-full h-0 pb-[56.25%] overflow-hidden">
        ...
        {isHovered && (
          <div className="absolute inset-0 bg-black bg-opacity-75 flex flex-col items-center justify-center transition-opacity duration-300 ease-in-out">
            <LinkIcon className="h-1/6 w-1/6 mb-2" />

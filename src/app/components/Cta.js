    ...
    <div ref={containerRef} className="bg-black">
      <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 ref={headingRef} className="text-3xl font-bold tracking-tight text-white sm:text-4xl font-mono">
            Have a project? Let&apos;s talk.
          </h2>
          <p ref={textRef} className="mx-auto my-6 max-w-xl text-lg leading-8 text-white">
